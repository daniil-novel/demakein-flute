...
"""
Дизайн флейты-свистка с модифицированными настройками.
Основан на структуре Tapered_flute из демакин.
"""

import demakein
from demakein import design, design_flute

class Design_shaku(design_flute.Tapered_flute):
    transpose = 12 # 12 # 4 # 7
    ...
    min_hole_diameters = [ 2.5,4.5,6.0, 3.0,4.5, 2.5,5.5,5.5, 3.5,5.5, 13 ]
    max_hole_diameters = [ 2.8,4.8,8.0, 5.0,7.5, 3.9,7.5,7.5, 5.5,7.5, 14.8 ]
